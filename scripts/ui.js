...
function renderTeamFilterBar() {
  // Remove any existing bar/wrap first
  const existing = document.getElementById('iplTeamFilterWrap') || document.getElementById('iplTeamFilterBar');
  ...
  // Wrap bar in a container to properly constrain it on mobile
  ...
  // Hide the right-fade when scrolled to the end
